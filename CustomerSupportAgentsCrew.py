"""
This code is based on an example from the DeepLearning.AI "Multi AI Agent Systems with crewAI" course.
...
support_agent = Agent(
    ...
    backstory=(
        "You work at crewAI (https://crewai.com) and are now working on providing support to {customer}, "
